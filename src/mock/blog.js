...
Mock.mock(/^\/api\/blog(\?.+)?$/, "get", function (options){
    ...
    return Mock.mock({
        ...
        data: {
            ...
            [`rows|${query.limit||10}`]: [{
                id: "@guid",//
                "title|1": ["每日必读：@ctitle(6, 20)", "心灵鸡汤：@ctitle(6, 20)", "心灵驿站：@ctitle(6, 20)", "技术宅：@ctitle(6, 20)", "惊！@ctitle(6, 20)", "动漫急先锋：@ctitle(6, 20)",
                    "娱人为乐：@ctitle(6, 20)", "体育新闻：@ctitle(6, 20)", "法律新闻：@ctitle(6, 20)", "以史为鉴：@ctitle(6, 20)", "娱乐梦工厂：@ctitle(6, 20)", "动漫社：@ctitle(6, 20)",
                    "人文社科：@ctitle(6, 20)", "走近科学：@ctitle(6, 20)", "萌宠物语：@ctitle(6, 20)",],//标题
                ...
                "thumb|1": [
                    "@image(300x250, @color, #fff, png, @title)", null
                ],//缩略图
